N_0 = eval(input('Give initial population size N_0: '))
r   = eval(input('Give net growth rate r: '))
dt  = eval(input('Give time step size: '))
N_t = eval(input('Give number of steps: '))
